...
protected:
    ...
    void apply_css() {
        ...
        css_provider->load_from_data(
            "button#quit { background: red; }"
            "button#post_message { background: green; }"
            "button#target_ads { background: blue; }"
            "button#dominance { background: purple; }"
        );
...
int main(int argc, char* argv[]) {
    ...
    network.readFromFile("social_network.txt");
