...
public:
    MainWindow() {
        ...
        top_dominator_label.set_name("top_dominator_label");
        grid.attach(top_dominator_label, 0, 5, 1, 1);

        top_dominator_value.set_name("top_dominator_value");
        grid.attach(top_dominator_value, 1, 5, 2, 1);

        top_influencer_label.set_text("Top Influencer:");
        top_influencer_label.set_name("top_influencer_label");
        grid.attach(top_influencer_label, 0, 6, 1, 1);

        top_influencer_value.set_name("top_influencer_value");
